...
/**
 * Clase principal (Main) que sirve como punto de entrada y ejecución de la
 * aplicación. Inicializa la lógica principal del programa.
 *
...
public class Main {
    ...
    /**
     * Método Principal ejecución del programa y que contiene toda la lógica del
     * mismo.
     *
